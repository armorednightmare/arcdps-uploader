...
namespace Revtc {
    ...
    std::string Parser::encounterName(BossID area_id)
    {
        ...
        switch (area_id)
        {
            ...
            //SotO Fractal CMs
            case BossID::KANAXAI:
            case BossID::KANAXAI_CM:
                return "Kanaxai";
            case BossID::EPARCH:
                return "Eparch (Lonely Tower)";
            ...
            case BossID::KELA:
                return "Kela";
            //Convergences
            case BossID::DEMON_KNIGHT:
                return "Demon Knight";
            case BossID::SORROW:
                return "Sorrow";
            case BossID::DREADWING:
                return "Dreadwing";
            case BossID::HELL_SISTER:
                return "Hell Sister";
            case BossID::UMBRIEL:
                return "Umbriel";
    ...
    std::pair<std::string, std::string> Parser::eliteSpecName(uint32_t elite)
    {
        switch (elite)
        {
            ...
            //EoD Elite Specs
            case 64:
                return std::make_pair("Virtuoso", "Virt");
            case 65:
                return std::make_pair("Catalyst", "Cata");
            case 66:
                return std::make_pair("Bladesworn", "Blds");
            case 67:
                return std::make_pair("Vindicator", "Vind");
            case 68:
                return std::make_pair("Mechanist", "Mech");
            case 69:
                return std::make_pair("Untamed", "Untm");
            case 70:
                return std::make_pair("Specter", "Spec");
            case 71:
                return std::make_pair("Harbinger", "Harb");
            case 72:
                return std::make_pair("Willbender", "Will");
            //SotO Elite Specs
            case 73:
                return std::make_pair("Deathshroud", "Dths");
            default:
                return std::make_pair("Unknown", "Unk");
                break;
        }
